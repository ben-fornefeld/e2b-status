...
export const colorVariants = cva(
  "transition-all border border-border duration-200",
  {
    variants: {
      variant: {
        ...
        dark: "bg-background-500 border-border-400",
        darkGradient:
          "bg-gradient-to-br from-background-300 to-background-500 border-border-400",
        darkGradientHover:
